...
contract EverETH is ERC20, Ownable {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "EverETH: The PanEthereumSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "EverETH: Automated market maker pair is already set to that value");
...
contract EverETHDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("EverETH_Dividen_Tracker", "EverETH_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "EverETH_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
