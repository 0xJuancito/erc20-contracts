...
contract BONEX is IERC20, Ownable {
    ...
    constructor() {
        ...
        marketingWallet = 0xD9Abcf35C6137954dDa45B91d4Db6c6CF3031E90;
        POGEX = 0xAEd8077B25c88AF2e711aBdcc24ef9389B028876;

        address newOwner = 0x249338c932d72500f019B3f66cC2758F44B3f9F1;
    ...
    function doContractSwap() internal swapping {
        ...
        uint256 tokensToBurn = (contractTokenBalance * sellBuyBackFee) /
            sellTotalFee;

        uint256 marketingFee = contractTokenBalance -
            (tokensToLp + tokensToBurn);
        ...
        if (tokensToBurn > 0) {
            swapTokensForTokens(tokensToBurn, POGEX);
        }
    ...
    function changeBuyFees(
        ...
        buyTotalFee = _liquidityFee + _marketingFee + buyBuyBackFee;
    ...
    function changeSellFees(
        ...
        sellTotalFee = _liquidityFee + _marketingFee + _sellBuyBackFee;
