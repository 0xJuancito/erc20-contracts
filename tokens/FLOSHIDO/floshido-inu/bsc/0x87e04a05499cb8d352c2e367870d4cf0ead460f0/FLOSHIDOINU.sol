...
contract FLOSHIDOINU is IERC20 {
    ...
    string constant private _name = "FLOSHIDO INU";
    string constant private _symbol = "Floshido";
    ...
    address payable public marketingWallet = payable(0x56738291E5f6a7f5b12D232AaDCE533D05af933C);
...
//===============================================================================================================
    ...
    function takeTaxes(address from, uint256 amount, bool buy, bool sell, bool other) internal returns (uint256) {
        ...
        if (burnAmount > 0) {
            _tOwned[address(DEAD)] += burnAmount;
            emit Transfer(from, address(DEAD), burnAmount);
        }
