/**
 ** #1 native fastest Telegram Trading Bot on Base
 ** https://blazebot.io 
 ** https://t.me/Blazebot_io
*/
...
contract BLAZE is ERC20, Ownable {
    ...
    function setSwapRouter(address _newSwapRouter) external onlyOwner {
        require(
            ...
            "BLAZE: The router already has that address"
        );
    ...
    constructor(address _swapRouterAddress) ERC20("BLAZE", "BLAZE") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            _swapRouterAddress
        );
        ...
        marketingWallet = address(0xCbaf4c676f21710a8381110feD61F80396f1Fd60); // set as marketing wallet
