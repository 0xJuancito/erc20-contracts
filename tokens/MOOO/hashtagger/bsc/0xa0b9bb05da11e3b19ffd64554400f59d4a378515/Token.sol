...
contract Token is ERC20, ERC20PresetFixedSupply {
    event BulkTransfer(uint256 indexed id);
    uint256 private constant TOTAL_SUPPLY = 30 * 1000 * 1000 ether;

    constructor(string memory name, string memory symbol)
        ERC20PresetFixedSupply(name, symbol, TOTAL_SUPPLY, msg.sender)
    {}
