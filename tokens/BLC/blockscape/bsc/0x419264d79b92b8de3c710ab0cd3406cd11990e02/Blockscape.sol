...
contract Blockscape is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Blockscape";
    string private _symbol = "BLC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc78E599006144eD906DdB790E366010Ac1f45d20);
    address payable public teamWalletAddress = payable(0xc78E599006144eD906DdB790E366010Ac1f45d20);
