...
contract MilkshakeSwapToken is BEP20('MilkshakeSwap Token', 'MILK') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying MilkshakeSwaps (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "MilkshakeSwap::_writeCheckpoint: block number exceeds 32 bits");
