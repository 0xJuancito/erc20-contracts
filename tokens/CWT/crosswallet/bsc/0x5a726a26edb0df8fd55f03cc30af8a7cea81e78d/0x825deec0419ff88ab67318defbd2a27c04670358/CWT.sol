...
contract CWT is BEP20CappedUpgradeSafe, OwnableUpgradeSafe, LGEWhitelisted {
    ...
    function initialize()
        ...
        initializer
    {
        __BEP20_init("CROSSWALLET.app", "CWT");
        __BEP20Capped_init(1000000000 * 10 ** 18);
        __Ownable_init();
