...
contract ZKSVM is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("zkSVM", "zkSVM") {
        ...
        marketingWallet = address(0x5C39D66AF7b41E94B5132A1a986f8844713d220f); // set as marketing wallet
