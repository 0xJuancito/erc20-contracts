...
- PulseFolio (Telegram: https://t.me/PulsefolioPortal)
...
contract PulseFolio is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 5e5 * 10**18; // 0.1%

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x79A2709bEfaC2701d062a9c109420b6E84e18C55;
    address public devWallet = 0x79A2709bEfaC2701d062a9c109420b6E84e18C55;
    ...
    constructor() ERC20("PulseFolio", "PULSE") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        require(new_amount <= 5e6,"Swap threshold amount should be lower or equal to 1% of tokens");
