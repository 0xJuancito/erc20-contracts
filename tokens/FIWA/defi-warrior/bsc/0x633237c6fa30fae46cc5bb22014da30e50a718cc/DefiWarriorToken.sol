...
// File: contracts\LockableERC20Token.sol
...
contract DefiWarriorToken is Ownable, ERC20 {
  using SafeMath for uint256;
  // metadata
  ...
  constructor() ERC20("Defi Warrior Token", "FIWA") Ownable() {
    _setupDecimals(18);
    _mint(0x1339c9aD4c6cA8993535Bcb7e401177e3DaC0fA2, 10000000000 * 10**decimals());
  }
