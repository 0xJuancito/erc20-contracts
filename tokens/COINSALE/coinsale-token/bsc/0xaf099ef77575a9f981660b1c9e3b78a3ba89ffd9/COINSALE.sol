...
//--- Contract v2 ---//
contract COINSALE is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x8a72746088b735b192Aa79b629f05CF917902053);


    IRouter02 public swapRouter;
    string constant private _name = "CoinSale Token";
    string constant private _symbol = "COINSALE";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        function changeTaxes(uint256 buy, uint256 sell) external onlyOwner {
            require(buy <= 10,"SAFU: Fees error");
            require(sell <= 10,"SAFU: Fees error");
