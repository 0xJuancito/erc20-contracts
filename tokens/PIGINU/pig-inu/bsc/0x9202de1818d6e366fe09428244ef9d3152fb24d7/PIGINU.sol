...
contract PIGINU is Context, IERC20, Ownable {
    ...
    {        
        ...
        marketingWallet = 0x8B00cE6d5C7532bBdFB33261c538779C1f7e0eeF;
        bigPotWallet = 0xdC107F84Fa05A68e9D4e31F91309826beeE463D9;
        
        swapEnabled = true;
        swapTokensAtAmount = _tTotal / 5000;

        transferOwnership(0x9970c596BEf22fAbdAA32404BB52B4D29F76561D);
...
//------------------Swap------------------//
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        payable(bigPotWallet).sendValue(newBalance - marketing);
