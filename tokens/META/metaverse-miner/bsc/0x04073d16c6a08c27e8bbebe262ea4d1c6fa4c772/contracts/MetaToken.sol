...
contract MetaToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "MetaToken";
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 1 * 10**18;
    ...
    constructor(address fund_) public {
        ...
        _isExcludedToFee[fund] = true;
        _isExcludedToFee[owner()] = true;
        _isExcludedToFee[address(this)] = true;

        emit Transfer(address(0), fund, _tTotal);
    }
    ...
    function includeToInFee(address account) public onlyOwner {
