...
contract SwiftSwap is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SwiftSwap", "SWS") {
        ...
        marketingWallet = address(0xad8116D37726B0b06830825c2251BEE49A66FCDf); // set as marketing wallet
    ...
    function updateBuyFees(uint256 fee) external onlyOwner {
        buyTotalFees = fee;
        require(buyTotalFees + sellTotalFees <= 15, "Must keep fees at 10% or less");
    }
    
    function updateSellFees(uint256 fee) external onlyOwner {
        sellTotalFees = fee;
        require(sellTotalFees + sellTotalFees <= 15, "Must keep fees at 10% or less");
    }
