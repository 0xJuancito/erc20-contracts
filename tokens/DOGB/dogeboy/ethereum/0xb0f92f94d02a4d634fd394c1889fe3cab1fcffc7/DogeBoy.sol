...
contract DogeBoy is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DogeBoy", "DOGB") {

        address _owner = 0xE9265F7b80618cbabF3A5A8ae30BBf5544ca7dD6;

        _decimals = 18;

        uint256 totalSupply = (10 ** 13) * (10**_decimals);
        ...
        marketingWallet = address(0xeeF4De43E6263a2A9fE6FCbb94B81B66DAC3906f); // set as marketing wallet

        minimumSwapBalance = 1 * (10**_decimals);
