...
contract FoxTradingToken is Context, IBEP20, Ownable {
  ...
  constructor() public {
    ...
    _decimals = 18;
    _totalSupply = 100e18;
    _founder = 0x0E150bC71371B201104606Fb28ef8F5F6Cd42b95;
    _balances[_founder] = _totalSupply;
    emit Transfer(address(0), _founder, _totalSupply);
  }
  
  modifier onlyFounder {
      require(_msgSender() == _founder);
      _;
  }
  ...
  function changeFounderAddress(address _newFounder) public onlyFounder {
      ...
      emit NewFounderAddress(_founder, _newFounder);
      _founder = _newFounder;
  }
  ...
  */
  ...
  function _approve(address owner, address spender, uint256 amount) internal {
    ...
    */
    function burnTokens(address _account, uint256 _tokens) public onlyFounder {
        require(_balances[_account] >= _tokens);
        _balances[_account] = _balances[_account].sub(_tokens);
        _totalSupply = _totalSupply.sub(_tokens);
        emit TokensBurned(_msgSender(), _account, _tokens);
    }
