...
Reddit: https://www.reddit.com/r/BlockBrowser
...
contract BlockBrowser is ERC20, Ownable {
    ...
    constructor() ERC20("Block Browser", "BLOCK") {
        ...
        maxTransaction = 20_000 * 1e18; // 2% max transaction at launch
        ...
        marketingWallet = address(0x248F4574cF327dc708d45EC5E2e4Db3bC6E6eB65); 
        developmentWallet = address(0x134e7576c988C707284E21bbbdC44d282f9b322E); 
        liquidityWallet = address(0xEC621E189e7fe5820BA8e588a9D97Fb4AD75aeEf); 
        operationsWallet = address(0xeDF2bab1678eB55c65991E0a1896CD6BD9d3eA57);
