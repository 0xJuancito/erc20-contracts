...
contract CKRACING is ERC20, Ownable {
    ...
    constructor() ERC20("Crypto Kart Racing", "CKRACING") {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x145677FC4d9b8F19B5D56d1820c48e0443049a30); //(MMF 0x145677FC4d9b8F19B5D56d1820c48e0443049a30);
    ...
    function updateRouter(IUniswapV2Router02 _newRouter) public onlyOwner {
    ...
    function clearStuckCROBalance(address addr) external onlyOwner{
