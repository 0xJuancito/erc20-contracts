/**
0xConnect
Enhance privacy and security by empowering AI.

An AI-powered decentralized protocol for private transactions on the Ethereum network features safety audit tools to mitigate risk and ensure security. 
0xConnect places high value on sustainability and provides holders with wothwhile rewards and advantages.
...
Website       : https://0xConnectHQ.io
X/twitter     : https://x.com/0xconnectHQ
Channel       : https://t.me/ZeroxconnectHQ
Whitepaper    : https://whitepaper.0xconnecthq.io/
Medium        : https://medium.com/@0xconnectHQ
Youtube       : https://www.youtube.com/@0xconnect-HQ
...
contract OxConnect is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"0xConnect" ;
    string private constant _symbol = unicode"0xCon" ;
    ...
    function notLimits() external onlyOwner{
