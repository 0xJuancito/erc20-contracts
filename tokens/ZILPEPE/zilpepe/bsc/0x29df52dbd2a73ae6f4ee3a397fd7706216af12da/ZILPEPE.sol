...
contract ZILPEPE is Context, IERC20, Ownable {
    using Address for address;
    //Contract Update Information
    string public constant contractVersion = "2.0";
    string public constant contractDev = "ZilPepe";
    string public constant contractEdition = "SAFU";
    //Definition of Wallets for Marketing or team.
    address payable public marketingWallet =
        payable(0x2FE98619364a284c08fD7fE7D88106afb2ad8a3C);
    //adding customer wallet to send supply and exclude from fees.
    address payable public safuWallet =
        payable(0x8A0FcAA7bd52355af12b699EB1D3Ea66a79477a4);
    ...
    //Supply Definition.
    uint256 private _tTotal = 420_690_420_690_420 ether;
    uint256 private _tFeeTotal;
    //Token Definition.
    string public constant name = "ZilPepe";
    string public constant symbol = "ZILPEPE";
    ...
    uint256 public minimumTokensBeforeSwap = 1;
    ...
    function enableTrading() external onlyOwner {
        ...
        emit AuditLog(
            "We have Enable Trading and Automatic Swaps:",
            msg.sender
        );
    }
