...
contract NX7 is ERC20, Ownable {
    ...
    address public operatorWallet; // 750,000
    ...
    constructor() ERC20("NX7", "NX7") {
        ...
        uint256 _operatorTokens = 3_750_000 * (10 ** tokenDecimals);
        ...
        liquidityWallet = address(0x331C8FC7A7950cec210F7BFD821A5BeAe45d0873); // 1,250,000
        operatorWallet = address(0x3783287158182992B33f0Ed83584065Fa786B5Ec); // 750,000
        ...
        /* CHANGE HERE */
        taxWallet = address(0x2B649DFd2601D0Db992d74400a6c3aCC6BfFde79); // set as tax wallet 
        ...
        _mint(operatorWallet, _operatorTokens);
