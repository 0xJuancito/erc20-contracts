...
// File @openzeppelin/contracts/utils/cryptography/ECDSA.sol@v4.7.1
...
// File @openzeppelin/contracts/utils/cryptography/draft-EIP712.sol@v4.7.1
...
// File @openzeppelin/contracts/token/ERC20/extensions/draft-ERC20Permit.sol@v4.7.1
...
// File contracts/ChildNonMintable.sol
    ...
    AccessControl
{
    ...
    constructor(address _childChainManagerProxy) ERC20(TOKEN_NAME, TOKEN_SYMBOL) ERC20Permit(TOKEN_NAME) {
