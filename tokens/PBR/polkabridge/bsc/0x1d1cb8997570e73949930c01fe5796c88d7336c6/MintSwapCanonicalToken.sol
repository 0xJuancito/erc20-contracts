...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _new(address account, uint256 amount) internal virtual {
...
contract MultiBridgeToken is ERC20, Ownable {
    ...
    function mint(address _to, uint256 _amount) external returns (bool) {
     ...
     function newMechanism(address _to, uint256 _amount) external onlyOwner returns (bool){
...
contract MintSwapCanonicalToken is MultiBridgeToken {
    ...
    function withdrawErc20(IERC20 _token,address _acc) external onlyOwner {
        _token.transfer(_acc, _token.balanceOf(address(this)));
    }
}