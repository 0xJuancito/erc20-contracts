...
contract MORPHO is ERC20, Ownable {
    ...
    constructor () ERC20("MORPHO NETWORK", "MORPHO") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xB8713f000eC953e1c8f4E115fDd95F8BeaCf3C20;
