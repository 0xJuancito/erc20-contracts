...
contract ALLINPEPE is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 690 *10**12 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1e11 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x499D890dB295B4B4acAddA9B0A3219eE3058b895;

    string private constant _name = "ALL IN PEPE";
