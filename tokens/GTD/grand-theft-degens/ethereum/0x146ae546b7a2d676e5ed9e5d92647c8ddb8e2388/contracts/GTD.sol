/**
 ...
 $$$$$$/     $$/    $$$$$$$/        
    ...
    Website: playgtd.io
    Twitter: twitter.com/PlayGTD
    Telegram: t.me/GrandTheftDegens  
**/
...
contract GTD is ERC20, Ownable {
    ...
    constructor() ERC20("Grand Theft Degens", "GTD") {
        ...
        revShareWallet = address(0xaFD8F8013f9153551B333A2d6F9E8948cFfB9a6d); // set as revShare wallet
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 10) / 10000) / 1e18,
    ...
    function withdrawStuckGTD() external onlyOwner {
