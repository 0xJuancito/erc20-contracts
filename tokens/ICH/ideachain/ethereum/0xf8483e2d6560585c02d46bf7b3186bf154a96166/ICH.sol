...
/**
 * IdeaChain smart contract.
 */
contract ICH is AbstractToken {
  /**
  ...
  uint256 constant MAX_TOKEN_COUNT = 55000000 * (10**8);
  ...
  string constant public name = "IdeaChain";
  string constant public symbol = "ICH";
