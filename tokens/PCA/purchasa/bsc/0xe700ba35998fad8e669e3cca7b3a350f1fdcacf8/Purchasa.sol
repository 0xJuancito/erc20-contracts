...
contract BEP20 is Ownable, IBEP20 {
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "Purchasa: transfer amount exceeds allowance");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "Purchasa: decreased allowance below zero");
    ...
    function _transfer(
        ...
        require(sender != address(0), "Purchasa: transfer from the zero address");
        require(recipient != address(0), "Purchasa: transfer to the zero address");

        _beforeTokenTransfer(sender, recipient, amount);

        uint256 senderBalance = _balances[sender];
        require(senderBalance >= amount, "Purchasa: transfer amount exceeds balance");
    ...
    function _mint(address account, uint256 amount) internal virtual onlyOwner {
        require(account != address(0), "Purchasa: mint to the zero address");
    ...
    function _approve(
        ...
        require(owner != address(0), "Purchasa: approve from the zero address");
        require(spender != address(0), "Purchasa: approve to the zero address");
 ...
 * @author BEP20 Generator Purchasa
 * @dev Implementation of the GeneratorCopyright
 */
contract GeneratorCopyright {
    string private constant _GENERATOR = "Purchasa";
 ...
 * @title Purchasa
 * @author Purchasa
 * @dev Implementation of the Purchasa
 */
