...
//Telegram: https://t.me/simplehubdev
//Twitter: https://x.com/simplehubdev
//Website: https://simplehub.dev
//Wp: https://simplehub.gitbook.io/simplehub-whitepaper/
//Beta: https://beta.simplehub.dev/dapp
...
contract SIMPLEHUB is ERC20, Ownable {
    ...
    address public marketingWallet = 0x94995F2e8a4553A871D94E57cA34D793Bb663FA9; 
    address public devWallet = 0xccB3b7380D28849F612D55Eee8b75E60fa7c7E0E;
    address public hubWallet = 0xccB3b7380D28849F612D55Eee8b75E60fa7c7E0E;
    ...
    Taxes public taxes = Taxes(13, 12, 0, 0);
    Taxes public sellTaxes = Taxes(13, 12, 0, 0);
    ...
    constructor() ERC20("SimpleHub", "SHUB") {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
         ...
         uint256 denominator = feeswap * 2;
          ...
          addLiquidity(tokensToAddLiquidityWith, ethToAddLiquidityWith);
            ...
            uint256 hubAmt = unitBalance * 2 * swapTaxes.hub;
            if (hubAmt > 0) {
                payable(hubWallet).sendValue(hubAmt);
            }
    ...
    function SetBuyTaxes(
        ...
        taxes = Taxes(_marketing, _liquidity,  _hub, _dev);
        require((_marketing + _liquidity + _hub + _dev) <= 25, "Must keep fees at 26% or less");
    }
    function SetSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _liquidity,  _hub,  _dev);
        require((_marketing + _liquidity + _hub + _dev) <= 25, "Must keep fees at 26% or less");
    }
    ...
    function updateHubWallet(address newWallet) external onlyOwner {
        require(newWallet != address(0),"Fee Address cannot be zero address");
        hubWallet = newWallet;
    }
