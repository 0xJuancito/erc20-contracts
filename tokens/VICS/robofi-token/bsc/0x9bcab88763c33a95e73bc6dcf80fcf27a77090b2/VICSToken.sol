...
// File: contracts\tokens\IRoboFiToken.sol
...
// File: contracts\tokens\RoboFiToken.sol
...
contract RoboFiToken is Context, IRoboFiToken, IMasterContract {
    ...
    /// @dev `data` is abi encoded in the format: (name, symbol, initamount, holder)
...
// File: contracts\tokens\vicstoken.sol
