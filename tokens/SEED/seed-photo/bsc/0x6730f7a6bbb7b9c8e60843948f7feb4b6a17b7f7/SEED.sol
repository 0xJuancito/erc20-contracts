...
contract SEED is ERC20,Ownable{
    ...
    function thawedAccount(address addr) 
        ...
        onlyOwner
    {
        require(frozenAccounts[addr], "Account is already Thawed!");
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount)
        ...
        override(ERC20)
    {
        require(!frozenAccounts[from], "Frozen Account Can not Transfer Token,Please Contact the Support Team!");
