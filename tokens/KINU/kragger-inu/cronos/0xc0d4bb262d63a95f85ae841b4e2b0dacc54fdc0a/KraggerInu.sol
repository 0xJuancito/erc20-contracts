...
contract KraggerInu is ERC20, Auth {
    ...
    string constant _name = "Kragger Inu";
    ...
    uint256 public liquidityFee    = 4; //set fees here 
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 1000; //total amount of tokens contract will sell each time
    bool inSwap;
