...
contract MeMeAl is ERC20, Ownable {
    ...
    constructor () ERC20("MeMe Al", "MeMeAl") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x043Ff48a5f452e687D6051AB26394Eeec08F6590;
        marketingWalletTwo = 0xF3df7234734Ef28b62Bf66c26B07D340F473fA92;

        transferOwnership(address(0x043Ff48a5f452e687D6051AB26394Eeec08F6590));
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        payable(marketingWalletTwo).sendValue(address(this).balance - initialBalance);
