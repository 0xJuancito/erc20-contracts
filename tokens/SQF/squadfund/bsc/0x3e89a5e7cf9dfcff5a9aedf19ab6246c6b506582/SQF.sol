...
contract SQF is Context, IERC20, Ownable {
    ...
    string private _name     = "SquadFund";
    string private _symbol   = "SQF";
    ...
    {        
        ...
        marketingWallet = 0x345d023537Bf95a206BCa02C732b4259fA7aF3b7;
        
        swapEnabled = true;
        swapTokensAtAmount = _tTotal / 5000;

        maxTransactionLimitEnabled  = true;
        maxTransactionAmountBuy     = _tTotal;
