...
contract Can {
    ...
    uint public constant totalSupply = 1000000000e18; // 1 billion Can
    ...
    function transferFrom(address src, address dst, uint rawAmount) external returns (bool) {
        ...
        if (spender != src && spenderAllowance != uint96(-1)) {
            uint96 newAllowance = sub96(spenderAllowance, amount, "Can::transferFrom: transfer amount exceeds spender allowance");
