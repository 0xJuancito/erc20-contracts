...
contract MoveCashToken is ERC20, Ownable {
    ...
    uint256 public antiBotAmount = 45000 * 10**18;
    uint256 public minSwapAmount = 15000 * 10**18;
    ...
    function _transfer(
        ...
        if (
            ...
            (amount > antiBotAmount || whales[sender]) &&
            sender != address(this) &&
