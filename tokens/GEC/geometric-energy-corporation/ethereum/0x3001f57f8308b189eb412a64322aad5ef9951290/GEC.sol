...
/*
    ...
    Geometric Energy Corporation (GEC) is a state-of-the-art technology company committed to facilitating positive social change
    of humanity by commercializing next-generation technologies within the sustainable energy, space, and computing industries.
...
contract GEC is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"GEC", unicode"GEC") {
