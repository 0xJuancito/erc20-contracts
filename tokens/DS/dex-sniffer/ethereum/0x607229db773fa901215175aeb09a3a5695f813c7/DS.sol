...
/**
Dex Sniffer is an ETH new pair finder with a built-in scanner and filters to find exactly the tokens you're looking for.
Whether you're a degen, a moderate trader, or a long-term holder.

Our bot:
@DexSnifferBot
Website:
https://dexsniffer-eth.com/
Twitter:
https://twitter.com/Dex_Sniffer
Telegram:
https://t.me/Dex_Sniffer
**/
...
contract DS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dex Sniffer";
    ...
    constructor () {
        _taxWallet = payable(0xd8CeAFd14c2F27Ea79ecb8c6616aA00488D3fc51);
