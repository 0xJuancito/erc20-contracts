...
// Root file: contracts/WEBFOUR.sol
...
2.buying webfour unlimited, selling webfour as equivalent 5 BNB
3. Reward Fee - 2% (stored as BNB)
4. Tresuary Fee - 5% (stored as BNB)
5. Buyback and Burn Fee - 1%
6. Reflections Fee for all users (who have balance more than 1 webfour) - 3%
...
*/
contract WEBFOUR is Context, IERC20, Ownable {
    ...
    string private constant _name = "WEBFOUR";
    string private constant _symbol = "WEBFOUR";
    ...
    function isSwapFeesEnabled() external view returns(bool) {
        return _isSwapFeesEnabled;
    }
