...
https://t.me/dojo_erc20
https://twitter.com/DOJO_ERC20
...
contract Dojo is ERC20, Ownable {
    ...
    constructor() ERC20("Project Dojo", "DOJO") {
        ...
        uint256 amountLP = totalSupply.mul(92).div(100);
        uint256 amountTeam = totalSupply.mul(8).div(100);
    ...
    function openDojo() external payable onlyOwner {
