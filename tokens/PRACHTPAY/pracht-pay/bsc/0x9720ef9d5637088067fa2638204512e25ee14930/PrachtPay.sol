...
contract PrachtPay is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pracht Pay", "PrachtPay") {
        ...
        marketingWallet = address(0x2d124df1DDa535acd1aa7C72FEB0aC93f27a0678); // set as marketing wallet
