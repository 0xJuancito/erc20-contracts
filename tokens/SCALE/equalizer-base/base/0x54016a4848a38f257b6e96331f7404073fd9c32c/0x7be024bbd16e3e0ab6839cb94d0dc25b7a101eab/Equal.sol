/**
 *v1.0.2
 *0x27cf00ea6d8b9df9db3c774af6a11b81e5be2976
...
contract Equal is OwnableUpgradeable {
    ...
    string public name;// = "Equalizer";
    string public symbol;// = "EQUAL";
    ...
    function initialize(string memory _n, string memory _s) public initializer {
        __Ownable_init();
        _mint(msg.sender, 0);
        name = _n;
        symbol = _s;
