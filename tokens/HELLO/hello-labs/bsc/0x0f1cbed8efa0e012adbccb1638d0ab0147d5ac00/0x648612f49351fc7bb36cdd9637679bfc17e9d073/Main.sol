...
contract Main is IBEP20, Auth, Initializable {
    ...
    function checkTxLimitExempt(address _wallet) public view returns(bool) {
        return isTxLimitExempt[_wallet];
    }
    function checkFeeExempt(address _wallet) public view returns(bool) {
    ...
    function checkBlackListed(address _wallet) public view returns(bool) {
