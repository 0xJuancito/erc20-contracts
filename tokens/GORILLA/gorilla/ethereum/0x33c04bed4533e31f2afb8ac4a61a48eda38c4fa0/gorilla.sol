...
contract Gorilla is Context , IERC20, Ownable {
    ...
    uint256 private _reductingPeriod3 = 3 days; // Reduce tax after opened - Tier 4
    uint256 private _preventSwapBefore= 50; // prevent the contract from swapping before 40 buys
    ...
    string public constant _name = unicode"Gorilla";
    string public constant _symbol = unicode"GORILLA";
