...
contract rebirth is ERC20, Ownable {
    ...
    uint256 public ThresholdTokens = 1e5 * 10**18;
    uint256 public maxWalletLimit = 1e5 * 10**18;
    address public marketingWallet = 0x1e67c3d93f261BFa6De7c6d8307C30EA061a8EcA;
    address public developmentWallet = 0x582Dd38DAA90c4C849Fe7Fe1A2cB19bBE272ceE0;
    ...
    Taxes public buytaxes = Taxes(3, 0, 2);
    ...
    function updateBuyTaxes( uint256 _marketing, uint256 _liquidity, uint256 _development ) external onlyOwner {
        ...
        require((_marketing + _development + _liquidity) <= 10, "Must keep fees at 10% or less");
    }
