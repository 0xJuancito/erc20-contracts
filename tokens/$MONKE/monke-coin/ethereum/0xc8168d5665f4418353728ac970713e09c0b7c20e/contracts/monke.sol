...
https://t.me/MonkeCoin69
https://monkecoin.fun/
https://twitter.com/MONKEcoin69
...
contract MONKE is ERC20 ("MONKE", "MONKE"), Ownable {
    ...
    uint256 constant TOTAL_SUPPLY = 69_000_000_000_00 ether;
    uint256 public tradingOpenedOnBlock;

    bool private swapping;

    address public monkeWallet;
    ...
    event UpdatedmonkeWallet(address indexed newWallet);
    ...
    function setmonkeWallet(address _monkeWallet) external onlyOwner {
        require(_monkeWallet != address(0), "ERROR: _monkeWallet address cannot be 0");
        monkeWallet = payable(_monkeWallet);
        emit UpdatedmonkeWallet(_monkeWallet);
    }
    ...
    function swapBack() private {
        ...
        (success, ) = address(monkeWallet).call{value: address(this).balance}("");
    }
