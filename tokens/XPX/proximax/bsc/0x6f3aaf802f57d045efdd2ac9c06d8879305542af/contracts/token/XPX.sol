...
contract XPX is Context, AccessControl, BEP20, Pausable {
    using SafeMath for uint256;
    using Address for address;
     ...
     * construction.
     */
    constructor(string memory name, string memory symbol, uint256 cap_, address admin, address pauser, address minter) BEP20(name, symbol) public {
