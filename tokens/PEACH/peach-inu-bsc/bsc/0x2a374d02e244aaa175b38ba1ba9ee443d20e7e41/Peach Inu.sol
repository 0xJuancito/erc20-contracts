...
contract PeachInu is ERC20, Ownable {
    ...
    PeachInuDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xdAAF39E49e294c04727CA1C89c7A16b203Cf6Cd1;
    address public opsWallet = 0x40d1a40079Ba4E7952f8fF51A3c1E22a4D1bf8C2;
    address public devWallet = 0xd00Ce00d16058f80A0FB2af821ce824492Db2ac7;

    uint256 public swapTokensAtAmount = 5e12 * 10**9;
    ...
    Taxes public sellTaxes = Taxes(3, 3, 2, 2, 0);
    ...
    constructor() ERC20("Peach Inu", "PEACH") {
        dividendTracker = new PeachInuDividendTracker();
        ...
        */
        _tokengeneration(owner(), 5e15 * (10**9));
    }

    receive() external payable {}

    function updateDividendTracker(address newAddress) public onlyOwner {
        PeachInuDividendTracker newDividendTracker = PeachInuDividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "PeachInu: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "PeachInu: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[newPair] = value;
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "PeachInu: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "PeachInu: Cannot update gasForProcessing to same value"
        );
...
contract PeachInuDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("PeachInu_Dividen_Tracker", "PeachInu_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "PeachInu_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "PeachInu_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "PeachInu_Dividend_Tracker: Cannot update claimWait to same value"
        );
