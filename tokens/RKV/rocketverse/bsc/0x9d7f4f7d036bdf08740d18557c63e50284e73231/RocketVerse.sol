...
// Created by RocketVerse Team
// Visit our website: https://rocketverse.space/
...
contract RocketVerse is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RocketVerse";
    string constant _symbol = "RKV";
    uint8 constant _decimals = 9;

    //total supply: 1T
    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);

    //max transaction amount: 0.01% -> 100.000.000
    uint256 public _maxTxAmount = ( _totalSupply * 10 )  / 100000;
