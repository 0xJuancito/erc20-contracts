...
contract LGEWhitelisted is Context {
    ...
    function _applyLGEWhitelist(
        ...
        if (sender == _lgePairAddress && recipient != _lgePairAddress) {
            ...
            if (wlRoundNumber > 0) {
                WhitelistRound storage wlRound =
                _lgeWhitelistRounds[wlRoundNumber.sub(1)];
...
contract LQT is Context, IBEP20, Ownable, LGEWhitelisted {
    using SafeMath for uint256;
