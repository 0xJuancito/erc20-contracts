...
contract CradleOfSins is IERC20 {
    ...
    string constant private _name = "Cradle of Sins";
    string constant private _symbol = "COS";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        development: payable(0xB62006d203adEDb69322587ACa0ee70D03fbE6a5)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 development, uint16 burnTax) external onlyOwner {
        _ratios.burn = burnTax;
        _ratios.development = development;
        _ratios.totalSwap = development + burnTax;
    ...
    function contractSwap(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        bool success;
        (success,) = _taxWallets.development.call{value: address(this).balance, gas: 35000}("");
    }
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        ...
        uint256 swpAmount = feeAmount - burnAmount;
        ...
        if (swpAmount > 0) {
            _tOwned[address(this)] += swpAmount;
            emit Transfer(from, address(this), swpAmount);
        }
