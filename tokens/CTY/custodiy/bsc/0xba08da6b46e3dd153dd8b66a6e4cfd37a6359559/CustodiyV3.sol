...
/*
    This is the V3 contract for relaunch and migration of V2 of "Custodiy Token ($CTY)" with CA: "0x5cF1661A741B7f051214b097f84F2E5B11845018"
    Author: @Th3nD
    Website: www.custodiy.com
*/
...
contract CustodiyV3 is ERC20, Ownable {
    ...
    address public marketingWallet = 0x207Eb3C8DEc29E3a8C54aEC94D94b7083fc1263d;
    address public devWallet = 0x601a068E3ef5969BD6968d0411C30ad885333DBf;
    ...
    constructor() ERC20("Custodiy (V3)", "CTY") {
        _tokengeneration(msg.sender, 1_000_000 * 10**decimals());
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(new_amount <= 20_000 && new_amount > 0, "Swap threshold amount should be lower or euqal to 1% of tokens");
