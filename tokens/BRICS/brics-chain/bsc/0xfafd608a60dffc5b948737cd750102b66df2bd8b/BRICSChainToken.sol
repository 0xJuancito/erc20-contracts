...
contract BlackList is Ownable, BasicToken {
    ...
    /////// Getters to allow the same blacklist to be used also by other contracts (including upgraded BRICS Chain) ///////
...
contract BRICSChainToken is Pausable, StandardToken, BlackList {
    ...
    */
    ...
    function recoverTokens(address tokenAddress, uint256 tokenAmount) public onlyOwner {
        StandardToken(tokenAddress).transfer(owner, tokenAmount);
    }
