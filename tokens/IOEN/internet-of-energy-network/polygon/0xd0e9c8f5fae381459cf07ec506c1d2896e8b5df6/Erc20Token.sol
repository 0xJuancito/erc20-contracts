...
contract Erc20Token is Context, IERC20, IERC20Metadata {
    ...
    event ChildChainManagerProxyUpdated(address oldValue, address newValue);
    ...
    constructor(
        ...
        _ensureNotZeroAddress(childChainManagerProxy_);
        ...
        emit ChildChainManagerProxyUpdated(address(0), childChainManagerProxy_);
    }
    ...
    function updateChildChainManager(address newChildChainManagerProxy) onlyAdmin external {
        _ensureNotZeroAddress(newChildChainManagerProxy);
        emit ChildChainManagerProxyUpdated(_childChainManagerProxy, newChildChainManagerProxy);
    ...
    modifier onlyChildChainManagerProxy() {
        require(_childChainManagerProxy == _msgSender(), ERROR_AUTH_FAILED);
        _;
    }
    
    function deposit(address user, bytes calldata depositData) onlyChildChainManagerProxy external {
