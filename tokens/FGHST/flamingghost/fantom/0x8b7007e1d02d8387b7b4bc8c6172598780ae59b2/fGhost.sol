...
// File: Contracts/Support/utils/Ownable.sol
...
// File: Contracts/Crematorium/Masterchef/Fghost.sol
 ...
 uint256 internal _maxSupply;
  ...
  function totalSupply() public view virtual override returns (uint256) {
    ...
    function mint(address account, uint256 amount) external onlyOwner{
            uint256 _maxMint = _maxSupply - _totalSupply;
        if (amount >= _maxMint){
            _mint(account, _maxMint);
        }
