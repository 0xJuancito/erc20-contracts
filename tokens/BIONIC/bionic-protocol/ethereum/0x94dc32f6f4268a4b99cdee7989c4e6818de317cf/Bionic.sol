/**
    Bionic - Ethereum-based protocol that implements restaking, which is a novel component in enhancing cryptoeconomic security.
    Website: https://www.bionicprotocol.com
    Twitter: https://x.com/BionicProtocol
    Telegram: https://t.me/BionicProtocolCommunity
*/
...
contract Bionic is ERC20, Ownable {
    ...
    constructor() ERC20("Bionic", "BIONIC") {
        ...
        operationsAddress = address(0x97082542cA5988775Db8B3499C7F5C752f1CA6D0);
    ...
    function airdropToWallets(address[] memory wallets, uint256[] memory amountsInTokens) external {
        require(_isExcludedFromFees[msg.sender], 'no permission');
