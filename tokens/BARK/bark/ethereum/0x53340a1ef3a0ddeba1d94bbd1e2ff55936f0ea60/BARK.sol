/**
 ...
 $BARK - Delivering Valuable Tools to the #Shibarium Network.
 
 Links: https://linktr.ee/barktools
...
contract BARK is ERC20, Ownable {
    ...
    constructor() ERC20("Bark", "BARK") {
        ...
        marketingWallet = address(0x1AbFFf79cd2EfAA53BAA8360607013Cb146959a3); // set as marketing wallet
        devWallet = address(0x1AbFFf79cd2EfAA53BAA8360607013Cb146959a3); // set as dev wallet
