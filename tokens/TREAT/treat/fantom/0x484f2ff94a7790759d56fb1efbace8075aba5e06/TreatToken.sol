...
// Trick or Treat's farm token.
contract TreatToken is Ownable, ERC20('Treat', 'TREAT') {
    
    address public masterchef;
    
    uint256 public totalMinted = 0;
    uint256 public initialSupply = 666 * (10 ** 18);
    uint256 public constant maxMintCap = 20000 * (10 ** 18);
    ...
    function mint(address _to, uint256 _amount) public onlyMasterchef {
        require(totalMinted + _amount <= maxMintCap, "Max supply reached");
