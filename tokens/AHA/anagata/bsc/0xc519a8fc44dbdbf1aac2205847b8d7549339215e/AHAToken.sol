...
contract AHAToken is ERC20, Ownable, HandlingTime {
  ...
  /**
   * The allowed amount to mint is represented in {pointOnePercent}.
  ...
  /**
   * Define all the checkpoints on which the owner can mint
   * more tokens and how many are allowed from that point
   *
