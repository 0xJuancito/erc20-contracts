...
contract ZATProject is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000 * 10**_decimals; // 100 million
    ...
    uint256 public _buyLiquidityFee = 1000000; // 10%
    uint256 public _buyTaxFee = 0; // 0%
    uint256 public _sellLiquidityFee = 1000000; //10%
    uint256 public _sellTaxFee = 0;
    uint256 public _transferLiquidityFee = 0;
    uint256 public _transferTaxFee = 100000; // 1%
    uint256 public _exchangeLiquidityFee = 0;
    uint256 public _exchangeTaxFee = 0;
    uint256 public _marketingFee = 40; // % of liquidityFee
    uint256 public _treasuryFee = 20; // % of liquidityFee
    uint256 public _charityFee = 10; // % of liquidityFee
    uint256 public _liqFee = 30; // % of liquidityFee
    ...
    function _transfer(
        ...
        uint256 treasuryBNB = BalanceBNB.div(100).mul(_treasuryFee);
        uint256 charityBNB = BalanceBNB.div(100).mul(_charityFee);
        ...
        //pay the charity wallet
        payable(_charityWallet).transfer(charityBNB);

        //pay the buyback wallet
        payable(_treasuryWallet).transfer(treasuryBNB);
    ...
    function F02_setTreasuryfee(uint256 treasuryfee) external onlyOwner() {
    ...
    function F02_setcharityfee(uint256 charityfee) external onlyOwner() {
    ...
    function W2_setTreasuryWallet(address _address) public onlyOwner() {
        _treasuryWallet = _address;
    }
    function W3_setLiquidityWallet(address _address) public onlyOwner() {
        _liquidityWallet = _address;
    }
    function W4_setcharityWallet(address _address) public onlyOwner() {
