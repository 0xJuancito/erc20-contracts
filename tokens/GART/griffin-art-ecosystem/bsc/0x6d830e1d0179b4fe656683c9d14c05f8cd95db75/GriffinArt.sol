...
// Check out griffinart.finance website for all the info about this token. 
...
contract GriffinArt is ERC20, Ownable {
    ...
    constructor () ERC20("Griffin Art Ecosystem", "GART") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xb50036073D5d9F24873833f7ea40E311E0941858;
