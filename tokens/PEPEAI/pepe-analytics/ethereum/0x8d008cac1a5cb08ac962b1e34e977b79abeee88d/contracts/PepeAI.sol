...
// Pepe Analytics (PEPEAI) - a memecoin dashboard focussed on delivering data.
// This utility based token is needed to access the dashboard to see all the data.
// Website: www.pepeanalytics.com
// Discord: discord.gg/pepeanalytics
// Twitter: www.twitter.com/pepeanalyticsai
...
contract PepeAI is ERC20, Ownable {
    ...
    address(0x110686a6B5DCd9f1a78D50Ad55bd871A45066CcD);

    address public devWallet =
    address(0xeAEb541CCE63493e3d921c0826121dcA5cf69376);

    uint256 _totalSupply = 441_000_000 * 1e18;
    ...
    constructor() ERC20("Pepe Analytics", "PEPEAI") {
    ...
    function addLiquidity() external payable onlyOwner {
        ...
        uniswapV2Router.addLiquidityETH{value: msg.value}(
            ...
            21_000_000 * 1e18, // liquidity amount
