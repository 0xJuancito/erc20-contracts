...
/**
   ...
   2% fee auto distributed to all hodlers(TAX FEE)
   2% fee auto distributed to the charity wallet
   1% fee auto sent to the dead wallet(BURN)
...
contract JaiHo is Context, IERC20, Ownable {
    ...
    string private _name = "Jai Ho";
    string private _symbol = "JaiHo";
    ...
    address public charityWallet = 0x4F0ED8B8246b048e651d65C020aA89101c7ad74D;
