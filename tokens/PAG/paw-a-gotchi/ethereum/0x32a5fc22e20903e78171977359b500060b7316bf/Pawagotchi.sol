/*
* Are you ready to enter the pawsome world of Paw-a-Gotchi and adopt your virtual pet friend?
*
* Website: https://pawagotchi.io/
* Telegram: https://t.me/pawagotchi_portal
* Twitter: https://twitter.com/pawagotchi
*
*/
...
contract Pawagotchi is ERC20, Ownable {
    
    uint256 public marketingFeeOnBuy    = 3;
    uint256 public marketingFeeOnSell   = 3;

    uint256 public projectFeeOnBuy      = 2;
    uint256 public projectFeeOnSell     = 2;

    uint256 public buyFee               = 5;
    uint256 public sellFee              = 5;


    address public marketingWallet = 0x227c051948E48118b16ec6eC2c7ed5fba2a1038E;
    address public projectWallet = 0x2ae847Ec221e3B41AeA86E256ec70726E89D7cc0;
    ...
    constructor () ERC20("Pawagotchi", "PAG") 
    {   
        ...
        _isExcludedFromMaxWalletLimit[projectWallet] = true;
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 totalShare = projectShare + marketingShare;
            ...
            if(projectShare > 0) {
                uint256 projectAmount = newBalance * projectShare / totalShare;
                sendETH(payable(projectWallet), projectAmount);
            }
