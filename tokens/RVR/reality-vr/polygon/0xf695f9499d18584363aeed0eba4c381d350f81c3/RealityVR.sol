/**
 *Hello Realıty-VR - RVR
 *OFFICIAL SMART CONTRACT
 *All rights of this smart contract are reserved. It cannot be copied and was created by REALITY-VR
...
/**
 *All rights of this smart contract are reserved. It cannot be copied and was created by REALITY-VR
 *Metaverse | Al are experiencing tremendous growth, and the R-VR Ecosystem Metaverse
 *Al strategy aims to enjoy additional returns and exposure to Metaverse 

 *Al-related assets, which provide funds for capital and have a debt system to users who want to participate in the Platform

 * Website:  www.realityvr.info
 * Twitter:  https://twitter.com/rvrecosystem
 * Discord:  https://discord.gg/FdNHMH3r
 * Telegram: https://t.me/RVREcosystem
 * Linkedin: https://www.linkedin.com/company/realityvr/
...
contract RealityVR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Reality-VR";
    ...
    uint256 private _totalTaxFeeOnBuy = 0;
