...
contract SquidToken is Ownable, ERC20, ReentrancyGuard {
    ...
    uint256 public rewardAmount = 10000 * (10 ** 18); //10k on BASE

    address public ultimateDrawWinner;
    bool public ultimateRewardClaimed = false;
    uint256 public ultimateRewardAmount = 100000 * 10 ** 18; // 1 million SQUID tokens // 100K on BASE

    // max limit reward to 500,000 SQUID tokens
    uint256 public constant maxRewardAmount = 50000 * (10 ** 18); //50k on BASE
    ...
    function initialDistribution() internal {
        ...
        uint256 developmentAllocation = (totalSupply * 1) / 100; // 1%
