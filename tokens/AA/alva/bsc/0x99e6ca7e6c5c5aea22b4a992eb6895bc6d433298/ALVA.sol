...
// AlVA Smartcontract Build on binance Smartchain
...
contract ALVA is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 19000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress = //MarketingWallet
        payable(address(0xaa8858E174D022c93d258a8DDa81f86E8665CB56));


    string private _name = "ALVA";
