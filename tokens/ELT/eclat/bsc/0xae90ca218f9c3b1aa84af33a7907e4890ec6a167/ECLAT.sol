...
contract ECLAT is Context, IERC20, Ownable 
{
    ...
    string private _name = "ECLAT";
    string private _symbol = "ELT";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 1; //0.1%
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _burnFee = 1; //0.1%
    ...
    function calculateTaxFee(uint256 _amount) private view returns (uint256) {
        _amount = _amount.mul(1000).div(1000-_burnFee);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
        ...
        uint256 burnAmount = amount.div(1000).mul(_burnFee);
