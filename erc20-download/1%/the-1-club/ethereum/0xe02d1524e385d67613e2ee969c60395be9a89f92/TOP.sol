...
/*
    ...
    Website: https://onepercentclub.top
    Discord: https://discord.gg/h86PdCRcBv
    Twitter: https://twitter.com/OnePercentTopC
    Telegram: https://t.me/onepercentclub_eth
...
contract TOP is ERC20, Ownable {
    ...
    constructor(address _owner) ERC20("The 1% Club", "1%") payable {
        ...
        marketingWallet = 0x1ea1F3C1dC952446E82Bb044AdB9c2F807717768;
        developmentWallet = 0xA161dBBC200486C143B328A3A76e5694F8ea4c99;
        ...
        _mint(developmentWallet, (totalSupply * 99) / 100);
        _mint(address(this), (totalSupply * 1) / 100);
