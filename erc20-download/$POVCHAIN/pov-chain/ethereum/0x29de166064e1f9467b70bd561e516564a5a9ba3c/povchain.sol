...
//--- Contract v2 ---//
contract povchain is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x55628F08f4d947bBCd1c90509FeA9b71e2A099B0);
    address payable private marketing2Address = payable(0x6bf35E66D227141616FDA303947861BA4348b2Bc);


    IRouter02 public swapRouter;
    string constant private _name = "POV Chain";
    string constant private _symbol = "$POVChain";
