/**
 *Submitted for verification at kovan-optimistic.etherscan.io on 2021-09-06
*/
...
// File @eth-optimism/contracts/libraries/standards/IL2StandardERC20.sol@v0.4.10
...
// File @eth-optimism/contracts/libraries/standards/L2StandardERC20.sol@v0.4.10
...
// File contracts/_0xBTC.sol

pragma solidity >=0.5.16 <0.8.0;

contract _0xBTC is L2StandardERC20 {
    constructor(
      address _l2Bridge,
      address _l1Token
    )
        L2StandardERC20(_l2Bridge, _l1Token, "0xBitcoin Token", "0xBTC")
        {
            _setupDecimals(8);
        }
}