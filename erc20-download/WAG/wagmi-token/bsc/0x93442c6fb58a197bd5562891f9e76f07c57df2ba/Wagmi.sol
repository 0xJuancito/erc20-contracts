...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x539da1726397019BC45f665a55394CA41406b425; // owner address
...
contract Wagmi is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x90796ff17adABC9EB3bd066ef86C4c4D6E791005); // Marketing Address
    address payable public teamWalletAddress = payable(0x1A5E91F0aa0B6a75Da2B39998614aBb094584AB3); // Team Address
