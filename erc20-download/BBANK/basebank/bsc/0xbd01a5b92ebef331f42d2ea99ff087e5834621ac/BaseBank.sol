...
contract BaseBank is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BaseBank", "BBANK") {
        ...
        marketingWallet = address(0x1799B49Cfa29435fE81a4bFD3106878eA19FC8f3); // set as marketing wallet
    ...
    function updateTFees(uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
