...
contract LIONCEO is ERC20, Ownable {
    ...
    constructor() payable ERC20("LionCeo", "LCEO") {
        ...
        marketingWallet = 0xD67D2eD3371C25058D3d91723E39Cf5E93654705;
        ...
        if( canSwap &&
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if((treasuryFeeOnBuy + treasuryFeeOnSell) > 0) {
                    ...
                    sendBNB(payable(marketingWallet), treasuryBNB);
