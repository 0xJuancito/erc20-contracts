...
// File: contracts/KREDupgradeable.sol
...
contract KRED is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC20PermitUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("KRED", "KRED");
        __ERC20Burnable_init();
        __Pausable_init();
        __AccessControl_init();
        __ERC20Permit_init("KRED");
        ...
        TOKENS_MAX_MINT = 10000000000000000000000000000000;
        tokenLaunched = false;
    }
