...
contract CPO is IERC20, OwnableUpgradeSafe, LGEWhitelisted {
    ...
    event UserBlacklistRemoved(address indexed user);
    ...
    function removeBlackList(address _user) public onlyOwner {
        ...
        emit UserBlacklistRemoved(_user);
    }
    ...
    function _approve(address owner, address spender, uint256 amount) internal virtual {
        require(!isBlacklisted[owner], "Owner is backlisted");
        require(!isBlacklisted[spender], "Spender is backlisted");
