...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    uint256 private constant _maxSupply = 300000000 * 1e18; 
...
// Burrow token
contract BurrowToken is BEP20('Burrow Token', 'BURROW') {
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "BURROW: _addMinter is the zero address");
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "BURROW: _delMinter is the zero address");
    ...
    function getMinter(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getMinterLength() - 1, "BURROW: index out of bounds");
