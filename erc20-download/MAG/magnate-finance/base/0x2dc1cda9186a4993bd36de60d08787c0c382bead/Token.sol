...
contract Token is Ownable, ERC20Permit {
    ...
    constructor(string memory name_, string memory symbol_) Ownable() ERC20(name_,symbol_) ERC20Permit(name_) {
        ...
        _mint(msg.sender, 150 * 1e6 * 1e18);
        _mint(address(treasuryLockToken), 100 * 1e6 * 1e18);
        _mint(address(motivateLockToken), 80 * 1e6 * 1e18);
        _mint(address(IDOLockToken), 100 * 1e6 * 1e18);
