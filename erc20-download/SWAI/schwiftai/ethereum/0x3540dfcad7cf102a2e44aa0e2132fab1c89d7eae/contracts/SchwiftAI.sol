...
Travel into another dimension with Schwift AI.

Travel deep into the universe and take part in an all inclusive AI suite at your fingertips and get rewarded on your investment. From image generation all the way to creating your own personalized beats and tunes! 
...
contract SchwiftAI is ERC20, Ownable {
    ...
    constructor() ERC20("SchwiftAI", "SWAI") {
        ...
        marketingWallet = address(0x53B44a09DCB2f5AbAb74F8D2e3ccaABF8A921Ae1); 
        developmentWallet = address(0x349dB6aB4b8A9b632DD773d50A5d34f68F5Bbd33); 
