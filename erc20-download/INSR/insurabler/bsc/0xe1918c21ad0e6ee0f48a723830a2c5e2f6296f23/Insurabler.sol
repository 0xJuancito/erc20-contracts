...
contract Insurabler is ERC20, Ownable {
    uint256 public tax = 5;

    address public marketingWallet = 0xDe96e2E03c2ab431BfA52b0Dce7AD6adBB6B2f90;
    ...
    constructor () ERC20("Insurabler", "INSR") 
    {   
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 tokensToLiquidity = contractTokenBalance / 5;
            ...
            addLiquidity(tokensToLiquidity, deltaBalance / 4);
