...
abstract contract ERC20 is Context, IERC20, IERC20Metadata, IERC20Errors, Ownable {
    ...
    function enableDisableTradin(bool value) external onlyOwner
    {
        tradeEnabled = value;
    }
    ...
    function _transfer(address from, address to, uint256 value) internal {
        ...
        if(msg.sender != owner())
        {
            require(tradeEnabled, "Trading is not enabled yet");
        }
...
contract VirtualX  is ERC20 {
    constructor() ERC20("Virtual X ", "VRL") {
