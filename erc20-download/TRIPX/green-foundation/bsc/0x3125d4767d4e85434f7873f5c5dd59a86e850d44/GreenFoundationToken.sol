...
// GreenFoundationToken with Governance.
contract GreenFoundationToken is BEP20('Green Foundation', 'TripX'), LGEWhitelisted {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "TripX::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "TripX::delegateBySig: invalid nonce");
        require(now <= expiry, "TripX::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "TripX::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "TripX::_writeCheckpoint: block number exceeds 32 bits");
