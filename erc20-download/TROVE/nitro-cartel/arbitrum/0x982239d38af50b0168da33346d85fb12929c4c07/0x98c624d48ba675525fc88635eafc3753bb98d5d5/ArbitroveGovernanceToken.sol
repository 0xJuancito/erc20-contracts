...
// File: @layerzerolabs/solidity-examples/contracts/contracts-upgradable/token/oft/IOFTCoreUpgradeable.sol
...
abstract contract LzAppUpgradeable is Initializable, OwnableUpgradeable, ILayerZeroReceiverUpgradeable, ILayerZeroUserApplicationConfigUpgradeable {
    ...
    function __LzAppUpgradeable_init_unchained(address _endpoint) internal {
...
// File: @layerzerolabs/solidity-examples/contracts/contracts-upgradable/token/oft/OFTCoreUpgradeable.sol
...
// File: @layerzerolabs/solidity-examples/contracts/contracts-upgradable/token/oft/IOFTUpgradeable.sol
...
contract ArbitroveGovernanceToken is Initializable, ERC20Upgradeable, ERC20SnapshotUpgradeable, OwnableUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, OFTCoreUpgradeable
 {
    // @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    ...
    function initialize() initializer public {
        __ERC20_init("Arbitrove Governance Token", "TROVE");
    ...
    function initializeLZ(address _lzEndpoint) public onlyOwner {
        __LzAppUpgradeable_init_unchained(_lzEndpoint);
        //lzEndpoint = ILayerZeroEndpointUpgradeable(_endpoint);
    }
    ...
    function _mint(address to, uint256 amount)
        ...
        override(ERC20Upgradeable, ERC20VotesUpgradeable)
    {
        require(totalSupply() + amount < 1000000000 * 10 ** decimals(), "over minting!");
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(OFTCoreUpgradeable) returns (bool) {
