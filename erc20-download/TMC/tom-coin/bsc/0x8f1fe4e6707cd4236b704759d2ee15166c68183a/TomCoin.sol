...
contract TomCoin is Context, IERC20, Ownable {
  ...
  address public MarketingAddress = 0x56c249B0F84C389D4A7822fb922A27390dD2d539;
  ...
  function excludeFromReward(address account) public onlyOwner {
    require(_excluded.length < 1000, 'Excluded list too long!');
    require(!_isExcluded[account], 'Account is already excluded');
    require(account != MarketingAddress, 'Cannot exclude Marketing address');
