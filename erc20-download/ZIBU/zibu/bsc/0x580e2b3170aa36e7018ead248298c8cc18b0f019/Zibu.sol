...
contract Zibu is ERC20, Ownable {
    ...
    uint256 public liquidityShare = 36;
    uint256 public devShare       = 15;
    uint256 public rewardShare    = 12;
    uint256 public buybackShare   = 6;
    uint256 public lmsShare       = 31;

    address public devWallet = 0xD792889B9bFCfD600fc5B75Bc3aA6251158f6Db2;
    ...
    address public buybackToken = 0xfCaDD830fF2D6Cf3AD1681E1e8FC5DDCe9d59E74;
    ...
    {   
        transferOwnership(0xBFcC3d7EB2a84d95726aEC6cfd23496aB5E5dA93);

        _mint(owner(), 1e12 * (10 ** 18));
        swapTokensAtAmount = 4e8 * (10 ** 18);

    	dividendTracker = new DividendTracker(2e6, BUSD);
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 25 && _sellFee <= 25, "Buy fee and sell fee cannot be more than 25%");
        buyFee = _buyFee;
        sellFee = _sellFee;
