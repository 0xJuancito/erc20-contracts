...
contract DWT is ERC20, Ownable {
    ...
    constructor () ERC20("Decentralized Exchange Wallet", "DWT") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x4Ec1603a14A82D727a79c9B7588176DCa86DB7aE;
        developmentWallet = 0x3Fecec123b9d90d09a10f40c65D1227f639535bC;
