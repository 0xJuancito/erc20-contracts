...
//--- Contract v3 ---//
contract MOONERIUM is Context, Ownable, IERC20 {
    ...
    uint256 constant private buyfee = 10;
    uint256 constant private sellfee = 10;
    uint256 constant private transferfee = 0;
    uint256 constant public fee_denominator = 1_000;
    uint256 constant private marketingFee = 6000; // 0.6%
    uint256 constant private developmentFee = 4000; // 0.4%
    ...
    address payable private marketingAddress = payable(0x68DAaca15aabcE3E3EC4f0125ec09595E35d566c);  
    address payable private developmentAddress = payable(0x6A44a9cBcC47Ee2dD26473584c4ae77c8Edd5E3c); 
...
//--- v3 Allocations --//
    ...
    string constant private _name = "MOONERIUM";
    string constant private _symbol = "MOONERIUM";
    string constant public A_Website = "https://moonerium.com/";
    string constant public A_Telegram = "https://t.me/MooneriumETH";
    string constant public A_Twitter = "https://twitter.com/MooneriumETH";
    string constant public A_Copyrights = "Dev @BR_BIGBOSS | Official TG @DiamondSkull_BBG";
    ...
    event NoFeeWalletUpdated(address indexed account, bool enabled);
    ...
    constructor () {
        ...
        require(buyAllocation + sellAllocation == 100," Must equals to 100%");
    ...
    function setNoFeeWallet(address account, bool enabled) public onlyOwner {
        ...
        emit NoFeeWalletUpdated(account, enabled);
    }
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 marketingAmount = (balanceETH * marketingFee) / 10000; 
        uint256 developmentAmount = (balanceETH * developmentFee) / 10000;  

        bool success;
            (success, ) = marketingAddress.call{value: marketingAmount, gas: 35000}(""); 
            (success, ) = developmentAddress.call{value: developmentAmount, gas: 35000}("");
