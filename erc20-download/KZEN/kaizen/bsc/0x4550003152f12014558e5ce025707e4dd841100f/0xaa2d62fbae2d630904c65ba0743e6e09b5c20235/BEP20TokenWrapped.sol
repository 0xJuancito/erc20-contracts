...
contract BEP20TokenWrapped is Ownable, Initializable, IBEP20, IWrappedToken {
    ...
    function version() external pure returns (string memory) { return "Kaizen BEP20 Token Wrapped v11.1"; }
    ...
    function initialize(
        ...
        require(_owner != address(0), "BEP20: zero owner address");
