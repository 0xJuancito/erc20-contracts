...
contract BOGEY is ERC20, Ownable {
    ...
    constructor() ERC20("Bogey", "BOGEY") {
        ...
        marketingWallet = address(0x024030CC98b41D161605D767dE44789b4A2583EB); // set as marketing wallet
        devWallet = address(0x8D50F715Be6914Eca441fBd5D7efb57eaEbF7dD1); // set as dev wallet
