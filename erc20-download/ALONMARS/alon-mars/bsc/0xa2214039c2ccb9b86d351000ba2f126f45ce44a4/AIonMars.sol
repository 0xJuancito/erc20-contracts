...
contract AIonMars is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0x1c061364e2ED79796c36c2a13fa2c684c19Ac54C);
    ...
    constructor () BEP20Detailed("AIon Mars", "AIonMars", 18) {
      _owner = msg.sender ;
    ...
    function setBuyMarketingFeePercent(uint256 updatedBuyMarketingFee) external onlyOwner {
        require(updatedBuyMarketingFee <= 0, "Buy fee should be less than 0%");
    ...
    function setSellMarketingFeePercent(uint256 updatedSellMarketingFee) external onlyOwner {
        require(updatedSellMarketingFee <= 0, "Sell fee should be less than 0%");
