...
contract BNBKinG is ERC20, Ownable {
    ...
    constructor () ERC20("BNBKinG", "BNBKING") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        transferOwnership(0xCa25906647168992195Ce586bdf2426F2cB14f03);
        ...
        marketingWallet = 0x011386A52deb6484A075952acAD7B0C1ac1078b8;
