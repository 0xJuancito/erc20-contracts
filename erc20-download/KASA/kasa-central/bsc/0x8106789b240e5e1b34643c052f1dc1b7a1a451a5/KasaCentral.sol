...
contract KasaCentral is IERC20 {
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x8fDB83aaa24EE6a3B39Ff2f736781C00DF913B43),
        development: payable(0x853c3858885a522bBE8ADbb56B7D3E3D665114c5)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 reflection, uint16 development, uint16 marketing) external onlyOwner {
