...
contract MShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 100.000 MSHARE
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund, address _treasuryFund) public ERC20("Savanna Share", "MSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 MSHARE for initial pools deployment
