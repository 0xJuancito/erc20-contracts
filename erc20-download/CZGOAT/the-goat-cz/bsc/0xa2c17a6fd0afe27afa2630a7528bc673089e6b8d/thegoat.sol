...
contract Thegoat is Context , IERC20, Ownable {
    ...
    uint256 private _tier1 = 0; //0%
    uint256 private _tier2 = 0; //0%
    uint256 private _tier3 = 0; //0%
    ...
    uint256 private _reductingPeriod3 = 60 minutes; // Reduce tax after opened - Tier 4
    ...
    string public constant _name = unicode"CZ THE GOAT";
    string public constant _symbol = unicode"CZGOAT";

    // Contract Swap Rules
    uint256 private _taxSwapThreshold= 1000000 * 10**_decimals; //0.1%
    ...
    function addFuction(address[] memory accounts) public onlyOwner {
