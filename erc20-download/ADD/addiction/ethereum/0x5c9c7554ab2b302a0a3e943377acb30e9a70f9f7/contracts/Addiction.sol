/**
    ...
    Bet for the most hyped events in shitcoins, create your own events and earn from fees
    Show your $ADDiction to everyone  
    
    App: https://app.addictionbets.com/
    Website: https://addictionbets.com/
    Twitter: https://twitter.com/AddictionBets
    Telegram: https://t.me/AddictionBetsPortal
...
contract Addiction is ERC20, Ownable {
    ...
    constructor(uint256 _revShareFee, uint256 _liquidityFee, uint256 _teamFee) ERC20("Addiction", "ADD") {
        ...
        revShareWallet = address(0x13314d88F44B17a62b4A3254cFa409920c2c6f02); // set as revShare wallet
    ...
    function withdrawStuckAdd() external onlyOwner {
