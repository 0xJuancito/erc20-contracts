...
contract Dawg is IERC20, Auth {
    string private constant _symbol  = "DAWG";
    string private constant _name    = "Dawg Coin";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply = 1000000000 * (10**_decimals);
  
    address payable private _marketingWallet = payable(0xA925fBE5f1A65dD5f6Af499AcDD389a9177BfD48);
