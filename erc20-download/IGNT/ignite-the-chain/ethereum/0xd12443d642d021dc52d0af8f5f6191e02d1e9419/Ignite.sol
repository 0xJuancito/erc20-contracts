...
contract Ignite is ERC20, Ownable {
    ...
    {   
        ...
        taxReceiverAddress = 0x2dC754A04C42b4CB7C88d8C3d33eDB264e527980;
        ...
        exemptFromFees[0x46f42bCd361D1c046823B25D4A839152093185CF] = true; // Dynamic Sale
    ...
    function updateBuyTax(uint256 _taxWithTwoDecimals) external onlyOwner {
        ...
        require(buyTotalTax <= 500, "Keep tax below 5%");
    ...
    function updateSellTax(uint256 _taxWithTwoDecimals) external onlyOwner {
        ...
        require(sellTotalTax <= 500, "Keep tax below 5%");
