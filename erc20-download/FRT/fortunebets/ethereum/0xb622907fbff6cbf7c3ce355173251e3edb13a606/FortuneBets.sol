...
// Twitter: https://twitter.com/FortuneOnETH
// Telegram: https://t.me/fortunebetsxyz
// Website: https://fortunebets.xyz/                                                                                                                                                                                                    //   
//  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//  @@                @@@                @@                @@@
//  @@                @@@                @@    @@@@@@@@    @@@
//  @@                @@@                @@  @@@@@@@@@@@@  @@@
...
contract FortuneBets is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Fortunebets.xyz";
    string private constant _symbol = unicode"FRT";
