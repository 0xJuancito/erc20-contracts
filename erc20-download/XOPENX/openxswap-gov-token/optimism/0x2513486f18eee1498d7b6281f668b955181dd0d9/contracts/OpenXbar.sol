...
contract OpenXGov is ERC20("OpenXSwap Gov Token", "xOpenX"), ERC20Snapshot{
    ...
    function init(IMC _masterchef) public {
        require(address(masterchef) == address(0));
        //To set same ratio old token to refund Masterchef Bug.
        _mint(msg.sender, 62643 * 10 ** 18);
        OpenX.transferFrom(msg.sender, address(this), 285889 * 10 ** 18);
