...
Website:  https://www.liquidprotocol.io/

Twitter: https://x.com/ProtocolLiquid

Technical Whitepaper: https://rather.gitbook.io/liquidprotocol
...
contract liquidprotocol is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x6A3395512d678F87f09b0e2AC3682026bC040463;
    address public donationWallet = 0xe7c7E2815012a85C937efa8FBDc870d967F205A6;

    string private constant _name = "Liquid Protocol";
    ...
    Taxes public taxes = Taxes(0, 34, 0, 37);
    Taxes public sellTaxes = Taxes(0, 34, 0, 37);
