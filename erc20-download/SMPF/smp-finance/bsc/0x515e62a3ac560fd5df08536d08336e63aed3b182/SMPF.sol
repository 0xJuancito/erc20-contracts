...
contract SMPF is ERC20, Ownable {
    ...
    constructor () ERC20("SMP Finance", "SMPF") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xEdAC7DdBFc591D7B460F444DE37F430F0C43466a;
        treasuryWallet = 0x0a8dB87Dc9DaACC238223F3995577e0920869f8d;
