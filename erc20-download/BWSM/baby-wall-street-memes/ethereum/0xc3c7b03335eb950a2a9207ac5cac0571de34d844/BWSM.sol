...
contract BWSM is ERC20, Ownable {
    ...
    constructor () ERC20("BABY WALL STREET MEMES", "$BWSM") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xD48480C953De6C62022B0DC61EF9e6682c4B7094;
        marketingWalletTwo = 0x90573449348cf14e4e9a4bb5050C1F83AEDE4E2E;
        ...
        _isExcludedFromMaxTxLimit[marketingWalletTwo] = true;
