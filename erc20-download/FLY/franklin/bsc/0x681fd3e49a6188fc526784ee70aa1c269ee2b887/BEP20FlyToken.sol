...
// Dependency file: contracts\interfaces\IBridgeTokenOperation.sol

// pragma solidity ^0.8.4;

interface IBridgeTokenOperation {
    /**
...
// Dependency file: contracts\FLy-Ethereum\ERC1132.sol
...
// Dependency file: contracts\FLy-Ethereum\LockableToken.sol

// pragma solidity >=0.4.22;
// import 'contracts\FLy-Ethereum\ERC1132.sol';
// import 'D:\repos\VRM\VRM-BRIDGE\VRM-FLy-bridge\VRM.FlyBridge.Contracts\node_modules\@openzeppelin\contracts\utils\math\SafeMath.sol';
// import 'D:\repos\VRM\VRM-BRIDGE\VRM-FLy-bridge\VRM.FlyBridge.Contracts\node_modules\@openzeppelin\contracts\token\ERC20\extensions\ERC20Burnable.sol';
...
contract LockableToken is ERC1132, ERC20Burnable {
    ...
    function lock(
        ...
        if (locked[_msgSender()][_reason].amount == 0) lockReason[_msgSender()].push(_reason);
     ...
     * @param _reason The reason to query the lock tokens for
     */
    function tokensLocked(address _of, bytes32 _reason) public view override returns (uint256 amount) {
     ...
     * @param _reason The reason to query the unlockable tokens for
     */
    function tokensUnlockable(address _of, bytes32 _reason) public view override returns (uint256 amount) {
     ...
     * @param _of The address to query the the unlockable token count of
     */
    function getUnlockableTokens(address _of) public view override returns (uint256 unlockableTokens) {
        for (uint256 i = 0; i < lockReason[_of].length; i++) {
...
// Root file: contracts\BEP20\BEP20FlyToken.sol

pragma solidity ^0.8.4;
// import 'D:\repos\VRM\VRM-BRIDGE\VRM-FLy-bridge\VRM.FlyBridge.Contracts\node_modules\@openzeppelin\contracts\token\ERC20\ERC20.sol';
// import 'D:\repos\VRM\VRM-BRIDGE\VRM-FLy-bridge\VRM.FlyBridge.Contracts\node_modules\@openzeppelin\contracts\access\AccessControl.sol';
// import 'contracts\interfaces\IBridgeTokenOperation.sol';
// import 'contracts\FLy-Ethereum\LockableToken.sol';

contract BEP20FlyToken is LockableToken, AccessControl, IBridgeTokenOperation {
    bytes32 public constant ADMIN_ROLE = keccak256('ADMIN_ROLE');

    constructor() LockableToken(0, 'Franklin', 'FLy') {
    ...
    function burn(uint256 amount) public override(ERC20Burnable, IBridgeTokenOperation) {
        require(hasRole(ADMIN_ROLE, _msgSender()), 'Caller is not an admin');
        _burn(_msgSender(), amount);
    }
}