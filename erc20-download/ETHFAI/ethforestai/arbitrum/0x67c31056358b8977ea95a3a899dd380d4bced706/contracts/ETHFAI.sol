...
contract ETHforestAI is IERC20, Ownable {

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string constant public name = "ETHforestAI";
    string constant public symbol = "ETHFAI";
    uint constant public decimals = 18;
    uint256 private _totalSupply = 100 * 1E9 * 10**decimals;

    address public taxWallet;
    uint public fundingTax = 2;
    uint public stakingTax = 2;
    ...
    function setTaxWallet(address _taxWallet) external onlyOwner {
        ...
        require(_taxWallet != taxWallet, "Token : same address.");
        taxWallet = _taxWallet;
    }
