...
WORLD PEACE HAS BEEN DELCARED

Web : https://peacecoin.world/
Twitter : https://twitter.com/WPCERC20
Tg : https://t.me/WorldPeaceCoin

With love by, @FDASHO on telegram.
*/
...
contract WORLDPEACE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"WORLD PEACE COIN";
    string private constant _symbol = unicode"WPC";
    ...
    constructor () {
        ...
        _teamWallet = payable(0x42Cc125EF59826a8503bd7fa8D60349aD19776B7);
    ...
    function DECLAREWORLDPEACE() external onlyOwner() {
