/**
    VegasBot offers in-house sportsbook betting combined with peer-to-peer customizable betting. Bet every sport from NCAAF to Celebrity Boxing all while never worry about pending withdrawals or KYC ever again.
    
    Website: https://www.vegasbot.app/
    Twitter: https://twitter.com/VegasTGBot
    Telegram: https://t.me/VegasBotPortal
    Telegram Bot: https://t.me/vegas_bets_bot
...
contract Vegasbot is ERC20, Ownable {
    ...
    constructor() ERC20("Vegasbot", "VEGAS") {
        ...
        revShareWallet = address(0x1326937cCBF03A6F237e5F3b1e5a6075939c397C); // set as VEGAS revShare multisig
        teamWallet = address(0xbF5d610cFEDBdB2b2328A749eaa6a5edA6695FE6); // set as VEGAS team multisig
