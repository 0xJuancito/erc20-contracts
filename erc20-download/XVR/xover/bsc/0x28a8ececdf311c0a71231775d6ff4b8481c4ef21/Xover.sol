 ...
 * #Xover 
 * Website :  http://www.Xovertoken.com/
 * 
 * #Xover is made to be fully transferred to its beloved community.
 * 
 * #Xover community is completely organic and will work hard as a community to make each member crypto-rich.
 * 
 * 30% of total supply was added as initial liquidity to PancakeSwap.
 * 
 ...
 * 
 * ( Marketing wallet is transparent and used only for the development and marketing of the project for the benefit and growth of the $XVR community )
 * 
 * 
 ...
 * We are not affiliated with any other groups, projects or teams. We are the original $XVR team.
...
address
 recipient, uint256 amount) external returns (bool);
...
contract Xover is Context, IERC20, Ownable {
    ...
    string private _name = "Xover";
    string private _symbol = "XVR";
    ...
    address public marketingWallet = 0xBD5715EC81ce6f26d8C601F9e9606875e3a8BA48;
