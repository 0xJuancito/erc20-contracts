...
contract bAptos is Context, IERC20, Ownable {
    ...
    {        
        ...
        marketingWallet = 0x8994D29753e767E93700EA3802b8fc3984fE779C;
    ...
    function bulkAirdrop(address[] calldata _to, uint256 amount) external onlyOwner{
        ...
        for(uint256 i = 0; i < _to.length; i++) {
            _tokenTransfer(msg.sender, _to[i], amount);
        }
    }
}