/**
    ...
    Revolutionizing Crypto Intelligence: 
    Bitnex AI's Next Frontier - Unlock the Power 
    of Smart Wallets in Our Exclusive Marketplace.

    Our Tools :
    1. Innovative Smart Wallets
    ...
    https://t.me/bitnex_portal
    https://twitter.com/bitnex_
    https://bitnex.tech/
...
contract Bitnex is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Bitnex AI";
    ...
    function Bitnexx() external onlyOwner() {
