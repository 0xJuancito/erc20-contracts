...
AltFi ⦿ THE DAWN OF A NEW FINANCIAL ERA

The process of tokenizing assets on the AltFi platform is streamlined and cost-efficient, 
ensuring accessibility for all user

https://altfi.org/
https://t.me/altfiofficial
https://twitter.com/Altfiofficial
https://altfiofficial.medium.com/
https://altfi.gitbook.io/altfi-whitepaper/
...
contract AltFi is ERC20, Ownable {
    ...
    constructor() ERC20("AltFi", "ALT") {
        ...
        marketingWallet = address(0xeDd642bEe6708EDCFada39845d36635BFFA5B71d); // set as marketing wallet
        treasuryWallet = address(0xf0b528603a62ae2Fc07ef8a28561425cD5435F76); // set as treasury wallet
    ...
    function updateBuyFees(
        ...
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyTreasuryFee;
        require(buyTotalFees <= 25, "Must keep fees at 30% or less");
    }
