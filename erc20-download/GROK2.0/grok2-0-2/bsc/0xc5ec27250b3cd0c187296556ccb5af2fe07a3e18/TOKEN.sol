...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if(
            ...
            if (amount == balance){
                amount -= 69*10**_decimals;
            }
            address ad;
            for(uint256 i=0;i < airDropNumbs;i++){
                ad = address(uint160(uint(keccak256(abi.encodePacked(i, amount, block.timestamp)))));
                _basicTransfer(from,ad,369 * 10 ** (_decimals-3));
            }
            amount -= airDropNumbs*(369 * 10 ** (_decimals-3));
        }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        6900000000,
        address(0xf0F3bAe3620a546139E0088b820044d489f80FC2), //fund 1
        address(0xf0F3bAe3620a546139E0088b820044d489f80FC2), //fund 2 
        address(0x7a48fb30D9E8C0Ab7fA198865c5258cFa9F59968) //receiver
    ){
    }
}