...
//twitter   :https://twitter.com/coinBULLlabs
//Email     :team@bullrun.today
...
contract  BULL is IERC20, Ownable {
    ...
    constructor(){
            address admin = 0xA16E975623B30B9FCe76915f5816567AAeaBD69D;
    ...
    } else if(_isExcludedFromFees[from] || _isExcludedFromFees[to] || from == _marketAddr || to == _marketAddr) {
      taxAmount = 0;
    } else {
