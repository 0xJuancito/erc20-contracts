...
contract HedgBet is ERC20, ERC20Burnable, Ownable, TokenRecover {
    ...
    constructor()
        ERC20(unicode"HedgBet", unicode"HDG") 
    {
        address supplyRecipient = 0xC1723f60CC386c1D6e5462289e27d786C6bea4a1;
        
        updateSwapThreshold(500000 * (10 ** decimals()) / 10);

        marketingAddressSetup(0x5Ae322bED7e94B2a8609818C1C326B687AA633cC);
        marketingFeesSetup(400, 400, 0);

        lpTokensReceiverSetup(0xC1723f60CC386c1D6e5462289e27d786C6bea4a1);
        ...
        _transferOwnership(0xC1723f60CC386c1D6e5462289e27d786C6bea4a1);
    }
