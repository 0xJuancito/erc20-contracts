...
/// @custom:security-contact dev@jellyfi.me
/// @custom:dev-run-script
contract JellyfishMobileToken is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("Jellyfish Mobile Token", "JFISH") {
