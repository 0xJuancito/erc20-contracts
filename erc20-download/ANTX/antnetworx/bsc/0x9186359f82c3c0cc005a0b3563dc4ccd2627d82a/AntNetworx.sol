...
contract AntNetworx is IERC20 {
    ...
    uint256 constant private startingSupply = 130_000_000;
    string constant private _name = "AntNetworX";
    ...
    address public marketingWallet = payable(0x8CA3697b9e237ABFaB4427Af9dA4a3F2FBFC2D4C);
...
//===============================================================================================================
    ...
    function setTrustedForwarder(address account) external onlyOwner {
        _trustedForwarder = account;
    }
