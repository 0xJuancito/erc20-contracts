...
@@@@@@@@@@@@@@@@@BGGB@@@@@@@@@@@@@@@@@@@@&BBGG@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@GG@@#5&@@@@&&&&&&&&&@@@@BG&@&5B@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@&5B@@@&PGGGGPPPPPPPPPPGGPB@@@@G5@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@5B@@@&BPPPPGGGGGGGGPPPGGB&@@@GP@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@GG@&BGGGB##BGGGGGGB###BGGG#&&5B@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@GPPY7!~~7YPB&GGGGB&BPJ!~!7?YG5&@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@?^~:..      .^?JJJ!:.      ..^^~5@@@@@@@@@@@@@
@@@@@@@@@@@@@@@!!:. ...     .:~!~..     ..  .^7?@@@@@@@@@@@@@
@@@@@@@@@@@@@@@5G7.         .JBGB7.     .   .JGY@@@@@@@@@@@@@
@@@@@@@@@@@@@@@YPP7:..   ..~G7  .YP^.    ..^?PP?@@@@@@@@@@@@@
...
A dog that is bored has a lot of time to do something. When someone innovates a lot, he didnt saw a dog watching from a window, thus leading to creation of an alpha, a dog that is fed by knowledge. He has a dream, and an extraordinary one. Found out his dream and his innovative skill, join on his adventure and be part of the history!


Join now: https://t.me/NoleInuPortal
Read more on: https://noleinu.com
*/
...
contract NoleInu is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xaF08CE8890Bd5eeEfbad0ece3A9987013470BB63;
    
    string private constant _name = "Nole Inu";
    string private constant _symbol = "N0LE";
    ...
    Taxes public taxes = Taxes(0, 3, 3);
    Taxes public sellTaxes = Taxes(0, 3, 3);
    Taxes private launchtax = Taxes(0, 60, 0);
    ...
    function setTaxes(
        ...
        require((_rfi + _marketing + _liquidity) <= 6, "Must keep fees at 6% or less");
