...
/*
 _______   _______    ______      _____  ________   ______   ________        ________  ________  _______  
/       \ /       \  /      \    /     |/        | /      \ /        |      /        |/        |/       \ 
$$$$$$$  |$$$$$$$  |/$$$$$$  |   $$$$$ |$$$$$$$$/ /$$$$$$  |$$$$$$$$/       $$$$$$$$/ $$$$$$$$/ $$$$$$$  |
$$ |__$$ |$$ |__$$ |$$ |  $$ |      $$ |$$ |__    $$ |  $$/    $$ |             /$$/  $$ |__    $$ |  $$ |
$$    $$/ $$    $$< $$ |  $$ | __   $$ |$$    |   $$ |         $$ |            /$$/   $$    |   $$ |  $$ |
...
contract Dollar is ERC20Burnable, Operator {
    ...
    modifier onlyTaxMan() {
        require(
            msg.sender == taxMan,
            "caller is not the owner or fund"
        );
        _;
    }
     ...
     */
    constructor() public ERC20("ZED", "ZED") {
        _mint(msg.sender, 45000 ether);//  Lauchpad & Init LP & DAO fund(450000 token)
        taxMan = msg.sender;
    }
    function newTaxMan(address _owner) public onlyTaxMan {
        taxMan = _owner;
    }
    function setTaxRate(uint256 _taxRate) public onlyTaxMan {
        require(_taxRate <= 5, "tax rate must be less than 5%");
        require(_taxRate >= 0, "tax rate must be greater than 0%");
        TAX_RATE = _taxRate;
    }
    function setRouter(address _router) public onlyTaxMan {
        router = _router;
    }
    ...
    function _transfer(
        ...
        if (recipient == router) {
            uint256 tax = amount.mul(TAX_RATE).div(100);
            super._transfer(sender, recipient, amount - tax);
            super._transfer(sender, taxMan, tax);
        } else {
