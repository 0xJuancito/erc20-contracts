...
contract FREELA is ERC20, Ownable {
    ...
    event UpdateFees(uint256 marketingFeeOnTransfer, uint256 marketingFeeOnSell);
    event SwapAndSendMarketing(uint256 tokensSwapped, uint256 bnbSend);
    event SwapTokensAtAmountUpdated(uint256 swapTokensAtAmount);

    constructor () ERC20("DecentralFree", "FREELA") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x65e48206d4A51D4fe9FA983aB4B673e4cEEFc3B2;
    ...
    function updateFees(uint256 _marketingFeeOnSell, uint256 _marketingFeeOnTransfer) external onlyOwner {
        ...
        emit UpdateFees(marketingFeeOnTransfer, marketingFeeOnSell);
    }
