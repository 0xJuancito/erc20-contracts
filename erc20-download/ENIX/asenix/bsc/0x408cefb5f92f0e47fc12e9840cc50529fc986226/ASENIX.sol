...
contract ASENIX is Context, IERC20, Ownable {
    ...
    string private _name     = "ASENIX";
    string private _symbol   = "ENIX";
    uint8  private _decimals = 18;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 500000000 * (10 ** _decimals);
    uint256 private visibleSupply = 500000000 * (10 ** _decimals);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 public taxFeeonBuySell;
    uint256 public ENIXLabsFee;
    ...
    {        
        ...
        burnFeeOnBuy = 0;
        burnFeeOnSell = 0;
        totalBuyFees = taxFeeonBuySell + liquidityFeeonBuy + burnFeeOnBuy;
        totalSellFees = ENIXLabsFee + liquidityFeeonSell + burnFeeOnSell;
    ...
    function setBuyFee() private{
        if(_taxFee == taxFeeonBuySell && _liquidityFee == liquidityFeeonBuy && _burnFee == burnFeeOnBuy) return;

        _taxFee = taxFeeonBuySell;
        _burnFee = burnFeeOnBuy;
        _liquidityFee = liquidityFeeonBuy;
    }

    function setSellFee() private{
        if(_taxFee == ENIXLabsFee && _liquidityFee == liquidityFeeonSell && _burnFee == burnFeeOnSell) return;
