 ...
 * @title ChaosToken
 *
 * @dev A minimal ERC20 token contract for the Chaotic Finance token.
 */
contract ChaosToken is ERC20Upgradeable {
    uint256 private constant TOTAL_SUPPLY = 100000000e18;

    function __ChaosToken_init(address genesis_holder) public initializer {
        __ERC20_init("Chaotic Finance Token", "CHAOS");
