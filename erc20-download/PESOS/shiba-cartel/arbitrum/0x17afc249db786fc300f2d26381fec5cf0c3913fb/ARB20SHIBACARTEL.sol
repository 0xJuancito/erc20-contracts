...
contract ARB20SHIBACARTEL is ERC20, Auth {
    ...
    string public constant name = "Shiba Cartel";
    string public constant symbol = "PESOS";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xE9fE8147fc793fe3bb70C7A772150a59e47Dad7D;
        operationsFeeReceiver = 0x589739322B9EE9fda577F5E698521699cc6fFF5D;
    ...
    function setSwapBackSettings(bool _enabled, uint256 _denominator) external onlyOwner {
        require(_denominator > 10, "Amount too high");
    ...
    function migrate(address[] calldata addresses, uint256[] calldata tokens) external authorized {
