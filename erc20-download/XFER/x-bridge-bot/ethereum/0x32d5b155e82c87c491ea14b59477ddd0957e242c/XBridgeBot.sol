...
/* 
    https://twitter.com/elonmusk/status/1683877911315599360

    Stake $XFER to take advantage of Revenue Sharing, and Premium @SpaceBridgeBot services.

    @SpaceBridgeBot is a Telegram Bot which allows you to trade and bridge transactions across multiple chains anonymously - No Wallet Connection required!

    TG: https://t.me/SpaceBridgePortal
    Website: https://www.spacetrader.app
    Twitter: https://twitter.com/SpaceBridgeBot
...
contract XBridgeBot is ERC20, Ownable {
    ...
    constructor(address _owner) ERC20("X BRIDGE BOT", "XFER") {
        uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );
        _approve(address(this), address(uniswapV2Router), type(uint256).max);

        address spaceMarketing = 0x7B5E8F409878931e080A2ae3c97B6b511Ee27fb2;
        ...
        marketingWallet = 0x69a4b726862ac748fdAebCCe9888094EdD13F526;
        developmentWallet = 0x9e4Dae14eed5194f85281b2dEB1002C572D4F2B2;
        ...
        excludeFromFees(spaceMarketing, true);
        ...
        excludeFromMaxTransaction(spaceMarketing, true);

        _mint(spaceMarketing, (totalSupply * 20) / 100);
    ...
    function XStart(uint256 _dx) external onlyOwner {
    ...
    function XLaunch() external onlyOwner {
