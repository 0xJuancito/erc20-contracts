...
contract TradeXAI is ERC20, Ownable {
    ...
    uint256 public walletToWalletTransferFee = 5;

    uint256 private _totalFeesOnBuy     = 7;
    uint256 private _totalFeesOnSell    = 10;

    address public marketingWallet = 0x533D89B2055195BCcBA58421bb05312B4075f589;
    ...
    event BuyFeesRemoved(uint256 marketingFeeOnBuy, uint256 rewardFeeOnBuy);
    event SellFeesRemoved(uint256 marketingFeeOnSell, uint256 rewardFeeOnSell);
    ...
    constructor() ERC20("TradeX AI", "TradeX") 
    {
        address newOwner = 0x18B798B14B767B94c5B93880A1D55e1D7E7e8C6B;
    ...
    function removeBuyFees() external onlyOwner {
        ...
        emit BuyFeesRemoved(marketingFeeOnBuy, rewardFeeOnBuy);
    }
    ...
    function removeSellFees() external onlyOwner {
        ...
        emit SellFeesRemoved(marketingFeeOnSell, rewardFeeOnSell);
    }
