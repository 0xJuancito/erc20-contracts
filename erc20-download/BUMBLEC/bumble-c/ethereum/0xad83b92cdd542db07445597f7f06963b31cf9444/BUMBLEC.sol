...
https://t.me/bumblecerc

https://twitter.com/bumbleceth
...
contract BUMBLEC  is Context, IERC20, Ownable {
    ...
    string private constant _name = "BUMBLEC";
    string private constant _symbol = "BUMBLEC";
    ...
    address payable private _developmentAddress = payable(0xb70345BF2bDedD91c9f4e263872Da3Ba9BBdffC1); 
    address payable private _marketingAddress = payable(0xb70345BF2bDedD91c9f4e263872Da3Ba9BBdffC1);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(taxFeeOnBuy >= 0 && taxFeeOnBuy <= 21, "Buy tax must be between 0% and 21%");
        require(redisFeeOnSell >= 0 && redisFeeOnSell <= 0, "Sell rewards must be between 0% and 0%");
        require(taxFeeOnSell >= 0 && taxFeeOnSell <= 21, "Sell tax must be between 0% and 21%");
