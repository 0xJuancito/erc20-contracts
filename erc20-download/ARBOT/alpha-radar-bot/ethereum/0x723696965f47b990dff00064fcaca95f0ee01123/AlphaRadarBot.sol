/**
    AlphaRadarBot
    Find out the next 100X alpha project with Alpha Radar Bot
    
    Website: alpharadarbot.xyz/
    Twitter: twitter.com/alpharadarbot
    Telegram: t.me/alpharadarbot_chat
    White paper: alpha-radar-bot.gitbook.io/doc/
**/
...
contract AlphaRadarBot is ERC20, Ownable {
    ...
    constructor() ERC20("Arbot", "ARBOT") {
        ...
        revShareWallet = address(0x037D1a874E265f1bcaddeF7735f5fbf1a83d7F37); // set as revShare wallet
    ...
    function withdrawStuckArbot() external onlyOwner {
