...
Telegram https://t.me/ToolsFi
Website https://tools-fi.org
*/
...
contract ToolsFi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tools-Fi";
    string private _symbol = "$Tools-Fi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFE620F692265188abCc6cf488b12e7Cde9c91B7a); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x9a1c0F906bc17c1A427946758850fdE127B858fe); // BuyBack Address
