...
contract GangsRabbit is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xA6fD94Ad8A791228244Fd319E26790b65965b9FE;
    address public opsWallet = 0x4119188d4DaF4601d85E1E864212D3C24b5c31Cd;
    address public devWallet = 0x4119188d4DaF4601d85E1E864212D3C24b5c31Cd;

    string private constant _name = "Gangs Rabbit";
    ...
    Taxes public taxes = Taxes(3, 4, 0, 0, 3);
    Taxes public sellTaxes = Taxes(3, 4, 0, 0, 3);
